...
public class Upcoming extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        propertyCardList = (RecyclerView) view.findViewById(R.id.upcoming_viewing_property_list);
        ...
        for (int i = 0; i < 5; i++) {
            ...
            propertyDetail.setCardType(OpenHouzConstants.CardType.UPCOMING_VIEWING_CARD);
